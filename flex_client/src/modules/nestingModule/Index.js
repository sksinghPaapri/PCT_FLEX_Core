...
import ConnectionApp from '../../microapps/connectionApp/Index';
import NestingApp from '../../microapps/nestingApp/Index';




export default function NestingModule() {
    const { dispatch, user } = useContext(UserContext)
    const [appNavigationCenter, setAppNavigationCenter] = useState(null);


    const getAppNavigationCenter = async () => {
        const response = await ApiService.get('appNavigationCenter/query?navigationCenterId=nav_nesting');
