...
import { AppContainer, AppHeader, AppContentContainer, AppContentForm, AppContentHeader, AppContentBody } from '../../../flex/flexBuilder/Index';
...
export default function DocumentList() {
    ...
    const createColumns = () => {
        ...
        const column = {
            headerName: '#', field: '_id', sortable: false, filter: false, cellRenderer: (params) =>
                <>
