...
import { DateField, SelectField, TextArea, TextField, CheckboxField } from '../../../flex/flexField/Index';
import LineContent from '../../../flex/flexComponent/LineContent';
import AppContentLine from '../../../flex/flexBuilder/AppContentLine';
...
import Decimal128Field from '../../../flex/flexField/Decimal128Field';
...
export default function Document() {
    ...
    const [isERPUpdating, setIsERPUpdating] = useState(false)
    ...
    MOUNT.ERP_UPDATING = setIsERPUpdating;
    const { id } = useParams();
    const isAddMode = !id;
    MOUNT.ISADDMODE = !id;
    ...
    const updateNetSuite = () => {
        AppController.updateNetSuite();
    }
    ...
    console.log(MOUNT.ERP_UPDATING);
                ...
                <Container fluid>
                    ...
                    <Row style={{ marginTop: '-10px' }}>
                        <Col className='p-0 ps-1'>
                            ...
                            {!isAddMode && <Button className='me-1' name="Update NetSuite"
                                variant='primary' size='sm'
                                type='button' onClick={updateNetSuite}>
                                {isERPUpdating ? "Updating..." : "Update ERP"}
                            </Button>}
